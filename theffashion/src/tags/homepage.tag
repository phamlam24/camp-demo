    ...
    <div id="home-page">
        <div>
            <div class="slide-banner flex-box">
                <div>
                    <div class="img">
                        <img class="slides" src="src/assets/jayden-huang-1243136-unsplash.jpg">
                        <img class="slides" src="src/assets/jim-flores-295810-unsplash.jpg">
                        <img class="slides" src="src/assets/freestocks-org-187367-unsplash.jpg">
                    </div>
